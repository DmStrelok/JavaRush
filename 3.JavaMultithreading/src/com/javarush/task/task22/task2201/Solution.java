    ...
    public synchronized String getPartOfString(String string, String threadName) {
        try {
            ...
            if (threadName.equals(Solution.FIRST_THREAD_NAME)) {
                TooShortStringFirstThreadException f = new TooShortStringFirstThreadException();
                f.initCause(e);
                throw f;
            }
            else if (threadName.equals(Solution.SECOND_THREAD_NAME)) {
                TooShortStringSecondThreadException f = new TooShortStringSecondThreadException();
                f.initCause(e);
                throw f;
            }
            else {
