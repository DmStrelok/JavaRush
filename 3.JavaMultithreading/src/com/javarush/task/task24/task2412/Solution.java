    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                if (((String) stock1.get("name")).compareTo((String) stock2.get("name")) != 0) return ((String) stock1.get("name")).compareTo((String) stock2.get("name"));
                ...
                gc1.setTime(d1);
                gc2.setTime(d2);
                gc1 = new GregorianCalendar(gc1.get(gc1.YEAR), gc1.get(gc1.MONTH), gc1.get(gc1.DAY_OF_MONTH));
                gc2 = new GregorianCalendar(gc2.get(gc2.YEAR), gc2.get(gc2.MONTH), gc2.get(gc2.DAY_OF_MONTH));
                if ((gc1.getTime()).compareTo(gc2.getTime()) != 0) return -(gc1.getTime()).compareTo(gc2.getTime());
                ...
                return ((last1 - open1 + change1 - (last2 - open2 + change2))) > 0 ? -1 : 1;
            }
        });
    }
